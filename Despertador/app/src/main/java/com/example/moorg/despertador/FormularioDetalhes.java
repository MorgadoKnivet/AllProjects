package com.example.moorg.despertador;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.twitter) {
			if (redeDisponivel()) {
				...
				Toast.makeText(this, "Conex�o com a Internet indispon�vel", Toast.LENGTH_LONG).show();
			}
...
//					String.valueOf(location.getLongitude()));
			...
			Toast.makeText(FormularioDetalhes.this, "Localiza��o salva", Toast.LENGTH_LONG);
		}

		public void onProviderDisabled(String provider) {
			// Requerido pela interface. N�o utilizado			
		}
