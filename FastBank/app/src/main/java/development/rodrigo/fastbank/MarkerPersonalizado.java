...
public class MarkerPersonalizado {
    ...
    private String latitude, longetude;
    private String endereçoBancoProxUm, endereçoBancoProxDois;
    private String idBancoProxUm, idBancoProxDois;
    private String status;
    private int n1G, n2G, n3G;
